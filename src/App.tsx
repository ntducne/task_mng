...
export default function TaskTable() {
  ...
  const loadingState = loading || tasks?.length === 0 ? "loading" : "idle";
    ...
    <div className="container mx-auto mt-5">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mt-5">
        ...
        >
          ...
          <TableBody items={tasks} loadingContent={<Spinner />} loadingState={loadingState} emptyContent="No tasks">
            {(item) => (
                ...
                <Form className="w-full gap-4 mb-5"
                  onSubmit={(e) => {
                    ...
                    if (action === "create_new") {
                      createNewItem(submitData as Task).then(() => {
                        fetchTasks(page);
                        addToast({
                          title: "Success",
                      ...
                      updateItem(submitData as UpdateTaskPayload).then(() => {
                        fetchTasks(page);
                        addToast({
                          title: "Success",
